...
<style> .wrapper a:link, .wrapper .w3-bar-item a:visited {text-decoration: none;}.w3-ul li:nth-child(odd) {
background: #F3F3F3;}.w3-ul{margin-left:0!important}</style>
...
<div class="w3-container">
	...
	<form action="#" method="POST" class="w3-container">
		...
		<div class="w3-margin-top w3-center">
			<button class="w3-btn w3-large w3-round-large w3-green" style="width:33.3%" type="submit" name="addnew"><?php echo i18n_r('massiveAdmin/ADDLINK'); ?></button>
		</div>
	</form>
</div>
<?php
