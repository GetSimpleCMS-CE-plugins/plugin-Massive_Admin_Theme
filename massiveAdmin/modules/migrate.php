...
<form action="#" method="POST" style="border:solid 1px #ddd;background:#fafafa;padding:10px;box-sizing:border-box;">
    ...
    <input type="submit" name="replaceMassiveUrl" style="color: #ffffff !important;
...
margin-top:10px;" value="<?php echo i18n_r('massiveAdmin/REPLACEDOMAIN'); ?>">
...
<form action="#" method="POST" style="border:solid 1px #ddd;background:#fafafa;padding:10px;box-sizing:border-box;margin-top:20px;">
    ...
    <label for="">
        ...
        <input type="checkbox" name="turnon" value="on" <?php
                                                        echo (@file_get_contents(GSDATAOTHERPATH . 'MassiveForceSSL/status.txt') == 'on' ? 'checked' : '');
                                                        ?>>
    </label>

    <input type="submit" name="forceSSLturnon" style="color: #ffffff !important;
text-decoration: none;
text-shadow: none !important;
background: #000 !important;
border:solid 1px #ddd;
padding:10px;
border: none !important;
margin-top:10px;" value="<?php echo i18n_r('massiveAdmin/SAVESSL'); ?>">
...
<?php if (isset($_POST['replaceMassiveUrl'])) {
