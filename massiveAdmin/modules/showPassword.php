<form action="#" method="post" style="padding:10px;background:#fafafa;border:solid 1px #ddd;box-sizing:border-box;">
    ...
    <label for="">
        ...
        <input type="checkbox" name="showPassword" value="on" <?php
                                                                echo (@file_get_contents(GSDATAOTHERPATH . 'MassiveShowPassword/status.txt') == 'on' ? 'checked' : '');
                                                                ?>>
    </label>
    ...
    <label for="">
        ...
        <input type="checkbox" name="removeForgetPassword" value="on" <?php
                                                                        echo (@file_get_contents(GSDATAOTHERPATH . 'MassiveShowForgetPassword/status.txt') == 'on' ? 'checked' : '');
                                                                        ?>>
    </label>
    <br>
